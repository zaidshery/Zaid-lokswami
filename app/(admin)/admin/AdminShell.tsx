...
const ADMIN_SURFACES: SidebarItem[] = [
  ...
  { icon: FileText, labelEn: 'Article Create', labelHi: HI.articleCreate, href: '/admin/articles/new', pageKey: 'article_create', section: 'content', visibleRoles: ['reporter'] },
