          ...
          <form onSubmit={handleSave}>
            ...
            {formData.isShort ? (
              <div className="space-y-4 rounded-lg border border-red-200 bg-red-50/50 p-4">
                ...
                <label className="block text-sm font-medium text-gray-900">Related published article ID or slug (Optional)<input name="articleId" value={formData.articleId} onChange={handleInputChange} placeholder="article-id-or-slug (optional)" className="mt-2 w-full rounded-lg border border-gray-300 bg-white px-3 py-2" /><span className="mt-1 block text-xs text-gray-600">Optional. Leave empty for standalone Reel/Short, or enter slug to enable “पूरी खबर पढ़ें”.</span></label>
