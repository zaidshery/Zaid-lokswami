      ...
      <div className="pointer-events-auto relative overflow-hidden rounded-2xl border border-primary-200/70 bg-white/95 p-3.5 shadow-[0_22px_52px_rgba(199,29,36,0.16)] backdrop-blur-md dark:border-primary-900/40 dark:bg-zinc-900/95">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href="/main/epaper"
            onClick={closeBanner}
            className="attention-pulsate-bck reader-touch-link reader-focus-ring inline-flex min-h-10 items-center gap-1.5 rounded-full border border-primary-200 bg-primary-50 px-3 text-xs font-semibold text-primary-700 transition hover:bg-primary-100 dark:border-primary-900/40 dark:bg-primary-950/30 dark:text-primary-300 dark:hover:bg-primary-950/45"
          >
          ...
          {canPromptForAlerts || shouldShowInstallForAlerts ? (
            <button
              ...
              className="reader-touch-button reader-focus-ring inline-flex min-h-10 items-center gap-1.5 rounded-full border border-primary-600 bg-primary-600 px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-60 dark:border-primary-500 dark:bg-primary-600 dark:hover:bg-primary-500"
            >
